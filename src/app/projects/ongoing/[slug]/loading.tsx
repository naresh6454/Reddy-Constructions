            ...
            <div className="space-y-6">
              ...
              <div className="p-6 bg-amber-50 dark:bg-amber-900/20 rounded-2xl border border-amber-200 dark:border-amber-800">
                <div className="flex justify-between mb-3">
                  <div className="h-4 w-40 bg-amber-200 dark:bg-amber-800 rounded animate-pulse" />
                  <div className="h-6 w-12 bg-amber-200 dark:bg-amber-800 rounded animate-pulse" />
                </div>
                <div className="h-3 bg-amber-200 dark:bg-amber-900 rounded-full overflow-hidden">
                  <div className="h-full w-1/2 bg-brand-yellow/50 rounded-full animate-pulse" />
                </div>
              </div>
